...
export default function AdminLoginPage() {
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    try {
      ...
      // ✅ مهم: نستخدم redirect:false للحصول على نتيجة وعدم دخول /admin قبل تثبيت الكوكي
      ...
      // ✅ تحويل كامل لضمان أن الجلسة/الكوكي مثبتة قبل الوصول للـ /admin (حل ممتاز على Vercel)
